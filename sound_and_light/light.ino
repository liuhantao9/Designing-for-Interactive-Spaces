...
uint8_t gesture[8][23] = {
   {12, 7,
   127,88,50,  127,88,50,  127,89,50,  127,91,50,  
   127,91,50,  127,89,50,  127,88,50},  
   {7,7,
   127,86,50,  127,84,50,  127,84,50,  127,86,50,  
   127,88,50,  127,88,50,  127,86,50},  
   {9,7,
   127,86,50,  127,88,50,  127,88,50,  127,89,50,  
   127,91,50,  127,91,50,  127,89,50},  
   {15,7,
   127,88,50,  127,86,50,  127,84,50,  127,84,50,  
   127,86,50,  127,88,50,  127,86,50}, 
   {47,7,
   127,84,50,  127,84,50,  127,86,50,  127,86,50,  
   127,88,50,  127,84,50,  127,86,50},  
   {105,7,
   127,88,50,  127,89,50,  127,88,50,  127,84,50,  
   127,86,50,  127,88,50,  127,89,50},  
   {99,7,
   127,88,50,  127,86,50,  127,84,50,  127,86,50,  
   127,79,50,  127,88,50,  127,88,50},  
   {12,7,
   127,89,50,  127,91,50,  127,91,50,  127,89,50,  
   127,88,50,  127,86,50,  127,8,450}, 
   };
...
//  rainbowCycle(1);
//  rainbow(1);
//    int a [3] = {0, 255, 0};  // Array for showcolor
//    int b [3] = {0, 0, 255};  // Array for showcolor
//    showColor(100, a, b);
    int c [3] = {0, 0, 0};
    crescendo(10, c, 1, 0);
...
void crescendo(uint8_t wait, int* a, int red, int green) {
  uint16_t i, j;
  ...
  for (j = 0; j < 256; j++) {
    ...
    for (i = 0; i < strip.numPixels(); i++) {
      strip.setPixelColor(i, strip.Color(a[0], a[1], a[2]));
    }
    strip.show();
    delay(wait);
  }
...
// 
void showColor(uint8_t wait,int* a,int* b) {
  uint16_t i, j;
  ...
  for (j = 0; j < 256 * 4; j++) { // n cycles of all colors on wheel
    ...
    for (i = 1; i < strip.numPixels(); i+=2) {
      strip.setPixelColor(i,strip.Color(b[0], b[1], b[2]));
      strip.setPixelColor(i-1,strip.Color(0, 0, 0));
    }
    strip.show();
    delay(wait);
